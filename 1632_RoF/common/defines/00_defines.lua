...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1631.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NCountry = {
	...
	AIR_SCORE_MULTIPLIER = 0.5,						-- Based on number of planes (which is typically a lot). Not as many here
...
NProduction = {
	...
	LICENSE_IC_COST_YEAR_INCREASE = 1,					-- IC cost equipment for every year of equipment after 1631
...
NMilitary = {
	...
	STRATEGIC_SPEED_BASE = 5.0,                 	-- Speed of strategic redeployment
